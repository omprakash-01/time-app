...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center px-6 py-12 sm:px-8 lg:px-16 xl:px-20 bg-white order-2 ">
      ...
      {/* Right Side  */}
      <div className="bg-blue-600 text-white flex flex-col justify-center px-6 py-12 sm:px-8 lg:px-16 xl:px-20 order-1 ">
